                ...
                <div class="grid grid-cols-4 gap-4 p-4 justify-end items-end">
                    <div class="grid-cols-2">
                        ...
                        <input
                            wire:model.live.debounce.300ms="search" type="text"
                               ...
                               placeholder="search name etc" required="">
                    </div>
                    ...
                    <div class="grid-cols-2">
                        <button
                            ...
                            wire:click="$dispatch('openModal', { component: 'exam.create-exam' })"
                        >
                            Create Exam
                        </button>
                    </div>
                        ...
                        @foreach ($exams as $item)
                            <tr wire:key="{{ $item->id }}" class="border-b dark:border-gray-700">
                                ...
                                <td class="px-4 py-3 flex items-start justify-center">
                                    <button
                                        type="submit"
                                        wire:click="$dispatch('openModal', { component: 'exam.update-exam', arguments: { exam: {{ $item->id }} } })"
                                    >
                                    ...
                                    >
                                        <x-heroicons::mini.solid.trash class="w-5 h-5 text-red-500" />
                                    </button>
                                </td>
                            </tr>
                        @endforeach
