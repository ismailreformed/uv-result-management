                ...
                <div class="grid grid-cols-4 gap-4 p-4 justify-end items-end">
                    ...
                    <div class="col-cols-2 ">
                        <button
                            ...
                            wire:click="$dispatch('openModal', { component: 'student.create-student' })"
                        >
                            Create Student
                        </button>
                    </div>
                    ...
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        ...
                        @foreach ($students as $item)
                            <tr wire:key="{{ $item->id }}" class="border-b dark:border-gray-700">
                                ...
                                <td class="px-4 py-3">{{ $item->roll }}</td>
                                ...
                                <td class="px-4 py-3 flex items-start justify-center">
                                    <button
                                        type="submit"
                                        wire:click="$dispatch('openModal', { component: 'student.update-student', arguments: { student: {{ $item->id }} } })"
                                    >
